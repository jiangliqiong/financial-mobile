    ...
    var restMoile = {
        ...
        toRestMobile: function() {
          ...
          if(isAllOk) {
            ...
            $.ajax({
              type: 'get',
              url: fx_path+'/wap/customer/modify-mobile.do?format=json&jsoncallback=?',
              data: {
                mobile: mobile,
                code: code
              },
              ...
              success: function(data) {
                 if(data.code == '10000') {
                   $('body').mildHintLayer({type:1,msg:'注册手机号修改成功'});
                   ...
                   $('body').mildHintLayer({type:2,msg:'您输入的手机号已被占用，修改失败'});
                 }else {
